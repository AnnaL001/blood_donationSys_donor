...
@section('vertical_navbar')
    ...
    <nav class="navbar bg-light">
        ...
        <ul class="navbar-nav" style="height:490px;">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/donor/blood_donation') }}" style="color:black;margin-left:10px;">Donation</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{url('/donor/history') }}" style="color:black;margin-left:10px;"> History</a>
            </li>
        </ul>
